...
use App\Mail\NewOfferAcceptedMail;
...
class SendNewOfferAcceptedJob implements ShouldQueue
{
    //send to the accepted freelancer
    ...
    public function handle(): void
    {
     ...
     try{
        Mail::to($user->email)->send(new NewOfferAcceptedMail(
            $this->freelancer,
            $this->offer,
            $this->project
